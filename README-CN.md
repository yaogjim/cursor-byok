...
[下载最新版](https://github.com/yaogjim/cursor-byok/releases/latest) · [问题反馈](https://github.com/yaogjim/cursor-byok/issues) · [English](./README.md)
...
| 发布身份 | 发布仓库和更新资源使用 `yaogjim/cursor-byok` | 不回写到上游发布资产 |
...
本 fork 会吸收上游的修复和能力增强，同时保留 `noad` 的产品策略。上游文档可作为通用安装配置参考；本 fork 的下载、更新资源和默认行为以 `yaogjim/cursor-byok` 为准。
